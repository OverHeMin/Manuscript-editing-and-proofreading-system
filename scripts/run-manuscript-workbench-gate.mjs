...
const steps = [
  ...
  },
  {
    ...
    args: [
      ...
      "test/proofreading/deep-proofreading-orchestrator.spec.ts",
      "test/proofreading/proofreading-service-deep-orchestrator.spec.ts",
      "test/proofreading/proofreading-rule-checker.spec.ts",
      "test/manuscripts/manuscript-api-deep-proofreading.spec.ts",
    ],
  },
  {
    label: "Real proofreading acceptance harness tests",
    command: "node",
    args: ["--test", "scripts/harness/run-real-proofreading-acceptance.spec.mjs"],
  },
  {
    ...
    args: [
      ...
      "test/manuscript-workbench-deep-proofreading.spec.tsx",
