...
### 4.14 Still-Open Retained Capability Lanes After 11E

After reconciling actual landed numbering through `11E`, two retained capability lanes remain
...
The practical planning implication after `11E` is:
