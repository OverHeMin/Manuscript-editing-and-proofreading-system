...
const expectedIndexes = [
  ...
  "retrieval_presets_scope_status_version_idx",
  "retrieval_presets_active_scope_uidx",
  "manual_review_policies_scope_status_version_idx",
  "manual_review_policies_active_scope_uidx",
