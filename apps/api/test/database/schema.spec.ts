...
const expectedTableColumns: Record<string, string[]> = {
  ...
  rule_package_extraction_candidates: [
    "id",
    "task_id",
    "package_id",
    "package_kind",
...
const expectedIndexes = [
  ...
  "residual_issues_execution_snapshot_created_at_idx",
  "residual_issues_novelty_key_created_at_idx",
  "residual_issues_route_validation_updated_at_idx",
  ...
  "template_compositions_manuscript_status_updated_at_idx",
  ...
  "knowledge_hit_logs_item_created_at_idx",
...
test("migration bookkeeping tracks the repo migration ledger in release order", () => {
  assert.deepEqual(
    ...
    [
      ...
      "0033_model_routing_temperature.sql",
