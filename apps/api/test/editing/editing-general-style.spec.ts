...
test("editing keeps general style findings advisory and separate from deterministic docx edits", async () => {
      ...
      async runChecks() {
        return {
          ...
          quality_findings_summary: {
            ...
            representative_issue_ids: ["editing-style-1"],
          },
  ...
  const result = await editingService.run({
    ...
    actorRole: "editor",
    storageKey: "edited/manuscript-1/style-output.docx",
    fileName: "style-output.docx",
  });
